    ...
    <main className="grid min-h-screen place-items-center px-6 py-12">
      <div className="grid w-full max-w-5xl gap-12 lg:grid-cols-[1fr_auto] lg:items-center">
        <section className="max-w-xl">
          <div className="mb-8 flex h-11 w-11 items-center justify-center rounded-md border border-border bg-chrome text-primary"><Camera aria-hidden="true" size={22} /></div>
